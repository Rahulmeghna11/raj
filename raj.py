...
CREATOR = "This File Is Made By @RAJPUTDDOS"
...
def verify():
    ...
    if computed_hash != stored_hash:
        raise Exception("This File Is Made By @RAJPUTDDOS.")
    print("This File Is Made By @RAJPUTDDOS.")
...
BOT_TOKEN = config['7685571959:AAGF7YcVvSTcezZXR56qZ3G1Gm1MbewUBH4']
ADMIN_IDS = config['1821595166']
...
def send_owner_info(message):
    owner_message = "This Bot Has Been Developed By @RAJPUTDDOS"
